...
- Keep this repository limited to the public informational site for JusTim LENOVO Backup.
- Never add OAuth client secrets, tokens, server credentials, private keys, `.env` values, backup data, or internal IP addresses.
- The declared Google OAuth scope must remain `drive.file`; do not broaden it.
